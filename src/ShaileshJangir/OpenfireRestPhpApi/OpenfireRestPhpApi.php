<?php
namespace ShaileshJangir\OpenfireRestPhpApi;
use GuzzleHttp\Client;

class OpenfireRestPhpApi
{
    ...
    private function callOpenFireApi($type, $endpoint, $params=array())
    {
    ...
    {
    	$endpoint = '/users';        
    	return $this->callOpenFireApi('get',$endpoint);
    }
    ...
    {
        $endpoint = '/users'; 
        return $this->callOpenFireApi('post', $endpoint, compact('username', 'password','name','email', 'groups'));
    }
    ...
    {
        $endpoint = '/users/'.$username; 
        return $this->callOpenFireApi('delete', $endpoint);
    }
    ...
    {
        $endpoint = '/users/'.$username; 
        return $this->callOpenFireApi('put', $endpoint, compact('username', 'password','name','email', 'groups'));
    }
    ...
    public function lockoutUser($username)
    {
        ...
        return $this->callOpenFireApi('post', $endpoint);
    }
    ...
    public function addToRoster($username, $jid, $name=false, $subscription=false)
    {
        ...
        return $this->callOpenFireApi('post', $endpoint, compact('jid','name','subscription'));
    }
    ...
    public function deleteFromRoster($username, $jid)
    {
        ...
        return $this->callOpenFireApi('delete', $endpoint, $jid);
    }
    ...
    {
        $endpoint = '/users/'.$username.'/roster/'.$jid;
        return $this->callOpenFireApi('put', $endpoint, $jid, compact('jid','username','subscriptionType'));     
    }
    ...
    {
        $endpoint = '/groups/';
        return $this->callOpenFireApi('post', $endpoint, compact('name','description'));
    }
    ...
    {
        $endpoint = '/groups/'.$name;
        return $this->callOpenFireApi('put', $endpoint, compact('name','description'));
    }
